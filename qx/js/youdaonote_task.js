...
function showmsg() {
  return new Promise((resove) => {
    ...
    const continuousDays = `连签: ${$.daily.continuousDays}天`
    const rewardSpace = `本次获得: ${($.signin.space + $.daily.rewardSpace )/ 1024 / 1024}MB`
    const totalReward = `任务总共获得: ${$.daily.totalRewardSpace / 1024 / 1024}MB`
